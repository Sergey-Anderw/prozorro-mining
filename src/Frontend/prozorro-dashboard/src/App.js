...
function App() {
    ...
    const [topProcurers, setTopProcurers] = useState([]);
    ...
    async function loadDashboard() {
        ...
        try {
            ...
            const procurers = (await procurersResponse.json());
